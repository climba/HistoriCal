...
var locations = [
    ...
    lat: 37.871754,
    long: -122.265188,
    title: "Springer Memorial Gateway",
    ...
    lat: 37.8757268,
    long: -122.257858,
    title: "Beta Theta Pi Chapter House",
    ...
    lat: 37.8763939,
    long: -122.259030,
    title: "Charles Keeler House & Studio",
    ...
    lat: 37.8766519, 
    long: -122.257213,
    title: "Phi Kappa Psi Chapter House",
    ...
    lat: 37.8776261, 
    long: -122.257434,
    title: "Hillside Club Street Improvements",
    est: "Established: 1910",
    ...
    lat: 37.8775837, 
    long: -122.257634,
    title: "Laura Belle Marsh Kluegel House",
    ...
    lat: 37.875915, 
    long: -122.255972,
    title: "Phi Delta Theta Chapter House",
    ...
    lat: 37.8755065, 
    long: -122.265329,
    title: "Thornburg (Normandy) Village",
    ...
    lat: 37.875333,
    long: -122.256882,
    title: "Captain Higgins' Temperance Grocery",
    ...
    lat:  37.8702404,
    long: -122.294695,
    title: "Church of the Good Shepard, Episcopal",
    est: "Established: 1878",
    ...
    lat:  37.869583,
    long: -122.295679,
    title: "Westminister Presbyterian Church",
    ...
    lat:  37.8645603,
    long: -122.297508,
    title: "West Berkeley Macaroni Factory",
    est: "Established: 1914",
    ...
    lat:  37.8782533,
    long: -122.303431,
    title: "Manasse-Block Tanning Co.",
    est: "Established: 1905",
    ...
    lat:  37.8592829,
    long: -122.292325,
    title: "Kawneer Manufacturing Co.",
    est: "Established: 1913",
   ...
   $("#end-location a").on('click', function(){
    ...
    for(var i =0; i < locations.length; i++) {
        if(locations[i].title === endLocation) {
