    ...
    // Berkeley Center
{
        ...
        photos_lg: ['<img src="http://bit.ly/2rCOK0p">', '<img src="https://bit.ly/2wyQygD">'],
        ...
        lat: 37.8776261, 
        long: -122.257434,
        title: "<strong>Bently House</strong>",
        ...
        },
        {
            ...
            photos_sm: ['<img src="URL" height="60px">', '<img src="URL" height="60px">'],
...
for (var i=0; i< locations.length; i++) {
    ...
    var div2 = 
    '<div class="card" style=" height: 13rem;">' + 
        '<img class="card-img-top"' + locations[i]["photos_lg"][1] + 
    '</div>';
    var imgC = "<img " + locations[i]["photos_lg"][1] + "/>";
 
    $("#landmark2").append(div2);
